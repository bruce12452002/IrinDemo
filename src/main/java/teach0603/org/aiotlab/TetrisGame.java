...
public class TetrisGame {
    ...
    public void setNewPiece(Shape.Tetrominoe shape) {
    ...
    public boolean isStarted() {
        return isStarted && (curPiece.getShape() != Shape.Tetrominoe.NoShape);
    }
