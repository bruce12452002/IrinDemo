...
//        System.out.println(file.getAbsolutePath());
        String file1 = "src/main/java/data/matrix1.csv";
        String file2 = "src/main/java/data/matrix2.csv";
        ...
        int rows1 = matrix1.length; // 2
        int cols1 = matrix1[0].length; // 3
        int rows2 = matrix2.length; // 3
        int cols2 = matrix2[0].length; // 2
        ...
        double[][] result = new double[rows1][cols2]; // 2 * 2 array
